# Reservoir & Upper Loop

The elevated reservoir serves as the top-end return point for the thermosiphon, providing final condensation, heat polishing, buffering, and system makeup.

### Upper Tunnel Exit & Pre-Staging Area
Steam exits the main tunnel directly into a **covered pre-staging / mixing zone**. This area features a rounded ceiling to encourage condensation and is heavily lined with heat exchange piping for efficient final heat capture. A significant portion of condensation occurs here, with additional condensation happening in the upper tunnel sections themselves (creating a helpful vacuum effect that strengthens the overall draft — essentially acting like a steam cannon).
...
A starter flow is introduced into all main canals (and overflows) to prime the system. Once running, flow rates are dialed back to match condensation return and maintain balance. In the double-V configuration this means managing 6 main canals, 6 overflows, and 4 stepped basins per section.
...
- Creates strong natural draft via condensation-driven vacuum.
